        ...
        mqttHelper.client.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String topic, MqttMessage mqttMessage) throws Exception {
                ...
                if (mqttMessage.toString().contains("pok")) {
                    ...
                    /**/
                    Toast.makeText(StopActivity.this, "docked", Toast.LENGTH_SHORT).show();
        ...
        animTimer = new CountDownTimer(5000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                if (i <= 3) {
                    ...
                    i = 0;
                    mTextField.setText("Cleaning in progress");
                }
                i++;
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (logo_stop.isEnabled()) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        Toast.makeText(StopActivity.this, "{\"data\":\"pause1\"}", Toast.LENGTH_SHORT).show();
                        //TODO: PAUSE
                        ...
                        waitTimer = new CountDownTimer(8000, 1000) {
                            public void onTick(long millisUntilFinished) {
                                if (mes_text.contains("pok")) {
                                    isRobotStop = true;
                                    Toast.makeText(StopActivity.this, "pok", Toast.LENGTH_SHORT).show();
                                    if (waitTimer != null) {
                                        waitTimer.onFinish();
                                        waitTimer.cancel();
                                        waitTimer = null;
                            ...
                            public void onFinish() {
                                ...
                                if (isRobotStop) {
                                    ...
                                    Toast.makeText(StopActivity.this, "Please, try again...", Toast.LENGTH_SHORT).show();
